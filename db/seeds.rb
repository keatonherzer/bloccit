...
5.times do
  ...
  5.times do
    ...
    post.update_attribute(:created_at, Time.now - rand(600..3536000))
  end
end

user = User.first
user.skip_reconfirmation!
user.update_attributes(email: 'keatonh12@gmail.com', password: 'helloworld', password_confirmation: 'helloworld')
